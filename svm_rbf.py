...
model_to_set = OneVsRestClassifier(SVC(kernel='rbf'), n_jobs=-3)
clf = GridSearchCV(model_to_set, param_grid,cv=5)
clf.fit(X_train, Y_train)
print("Best parameters set found on development set:")
print()
print(clf.best_params_)
print()
joblib.dump(clf.best_estimator_, 'rbf.model.pkl', compress = True)
...
joblib.dump(clf.best_estimator_, 'multi.model.pkl', compress = True)
